...
#include "message.hpp"
#include "message_types.hpp" // includes headers for all concrete message types and the x-macro list
...
// static factory method to deserialize json string into specific message subclass
